<?php
    ...
    $sql3="select * from investment_gold where id='$client'";
...
<html>
    ...
    <head>
       <meta charset="UTF-8">
        ...
        <title> Investment Gold | CapitalProFx Trading </title>
    ...
    <body>
        ...
        <div class="container-fluid mt-5">
          ...
          <center style="clear:both;">
                    <h3 class="mt-5 text-danger"> INVESTMENT GOLD</h3>
             ...
             <?php
                                ...
                                if(isset($_POST['plus'])){
                                    ...
                                    $price1 = mysqli_real_escape_string($conn, $_POST['price1']);
                                      ...
                                      $sql = "SELECT * FROM investment_gold WHERE plan_name1='$mini_name1'";
...
//                                    mysqli_query($conn, $sqlplus);
                                    ...
                                    $q1="insert into investment_gold (plan_name1, price1 ) values('$mini_name1', '$price1')";
                            ...
                            ?>
                             ...
                             <?php
                                ...
                                if(isset($_POST['submit'])){
                                   ...
                                   $sqlplus = "UPDATE investment_silver SET plan_name1='$mini_name1', price1 = '$price1' WHERE id='$client'";
                                    mysqli_query($conn, $sqlplus);
