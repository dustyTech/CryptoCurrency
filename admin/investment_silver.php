<?php
    ...
    $sql3="select * from investment_silver where id='$client'";
    ...
    <body>
        ...
        <div class="container-fluid mt-5">
          ...
          <center style="clear:both;">
                    <h3 class="mt-5 text-danger"> INVESTMENT SILVER</h3>
                        ...
                        <div class="col-md-6 p-5">
                            <div class="">
                                ...
                                <div class="form-group">
                                    <label>Silver Package Name</label>
             ...
             <?php
                                ...
                                if(isset($_POST['plus'])){
                                    ...
                                    $price1 = mysqli_real_escape_string($conn, $_POST['price1']);
                                      ...
                                      $sql = "SELECT * FROM investment_silver WHERE plan_name1='$mini_name1'";
...
//                                    mysqli_query($conn, $sqlplus);
                                    ...
                                    $q1="insert into investment_silver (plan_name1, price1 ) values('$mini_name1', '$price1')";
