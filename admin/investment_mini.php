<?php
    ...
    $sql3="select * from investment_mini where id='$client'";
    ...
    <body>
        ...
        <div class="container-fluid mt-5">
          ...
          <center style="clear:both;">
                    <h3 class="mt-5 text-danger"> INVESTMENT MINI</h3>
             ...
             <?php
                                ...
                                if(isset($_POST['plus'])){
                                    ...
                                    $price1 = mysqli_real_escape_string($conn, $_POST['price1']);
                                      ...
                                      $sql = "SELECT * FROM investment_mini WHERE plan_name1='$mini_name1'";
...
//                                    mysqli_query($conn, $sqlplus);
                                    ...
                                    $q1="insert into investment_mini (plan_name1, price1 ) values('$mini_name1', '$price1')";
