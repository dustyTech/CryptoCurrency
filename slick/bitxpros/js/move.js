  ...
  function move(transfer_code,amt,bit,url,meth,user_id,wallet_balance) {
        ...
        .then((value) =>{
          if(value != transfer_code){
            ...
            $.ajax({
                type: "POST",
                url: url,
                data: {amt: amt, bit:bit, transfer_code: transfer_code,meth:meth,user_id:user_id,wallet_balance:wallet_balance},
