...
<html lang="en">
  <head>
    ...
    <title> Reset Password | Bitxpros Trading</title>
        ...
        <div class="col-lg-5 col-md-12 col-form">
            ...
            <h4>Reset | Forget Password</h4>
              ...
              <div class="form-group " >
                ...
                <input type="text" class="form-control" placeholder="Enter new password" name="new_psw" required>
              ...
              <!-- ================end ====================== -->
                ...
                <input type="password" class="form-control" id="password" placeholder="re-enter password" name="renew_psw" required>
