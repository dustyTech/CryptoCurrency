...
<html lang="en">
  <head>
    ...
    <title>About us | Bitxpros Trading</title>
 ...
 <section class = 'container-fluid col-nav-area'>
      ...
      <!-- end nav bar section -->
        ...
        <!-- first section  -->
        <section class="container-fluid abt-us">
        	<div class="row">
	        	<div class="col-6 abt-us-txt">
	        		<h2> About Bitxpros Trading</h2>
	        	</div>

	        	<div class="col-6">
	        		<img class="flying-man" src="../images/flying-man.png">
	        	</div>
	        </div>
         ...
         <div class="container abt-p-txt">
	        	<p> 
	        		Bitxpros Trading is a distinctive investment company offering our investors access to high-growth investment opportunities in Bitcoin markets and other services. We implement best practices of trading & mining of Bitcoins through our operations, while offering flexibility in our investment plans. Our company benefits from an extensive network of global clients. At Bitxpros Trading company, we emphasize on understanding our client’s requirement and providing suitable solutions to meet their investment criteria. Our aim is to utilize our expertise & knowledge which will benefit our clients and the users of our services. Our company believes that when a team outperforms expectations, excellence becomes a reality.
	        	</p>

	        	<p>
	        		As a leader in the CFDs, Forex and Options trading market, Bitxpros Trading can offer it's clients unparalleled financial services through a wide variety of stocks, commodities, currencies, and indices. Clients have access to our team of knowledgeable financial experts and will find that trading CFDs, Forex and Options is easy with our unique trading platform. Bitxpros Trading conducts business worldwide and offers many international tradable assets for our clients to be always able to choose CFDs, Forex and Options from well-established financial products to the newest trends from emerging markets.
	        	</p>

	        	<p>
	        		The combination of our state-of-the-art trading platform, real-time professional market analysis, and personal manager support, gives all of our clients the tools to successfully trade CFDs, Forex and Options for profit.
	        	</p>
	        	
	        	<p> Bitxpros Trading is a progressive online trading platform providing customers from all over the world an opportunity to trade CFDs, Forex and Options with more than 90 financial assets, 24 hours a day, seven days a week. Round-the-clock access to exclusive reviews of financial markets by our analysts will help you make important trading decisions. Our customer support service will answer all of your questions in case of any problems. Our team is doing everything possible to be the first and only partner for beginners and experienced traders and investors looking for a simple, reliable and comfortable way to increase profits.
	        	</p>
	        </div>
