				...
				<div class="dash-main">
					...
					<div class="container" style="padding:10px;" >
						...
						<div class="col-12 align-middle">
							<h4> Wallet</h4>
							<p> The request for withdrawals can be made only on Friday and should be submitted between the hours of 6.00 AM to 7.00 AM GMT-7.
							</p>
							<br />
    ...
    <form method="post" enctype="multipart/form-data">
          ...
          <div id="show_banktransfer" style="display: none;">
                  ...
                  <select name="country" size="1" class="form-control" required id="country" style="font-family: Montserrat, sans-serif; height: 3.25rem; border-radius: 0px;">
                   ...
                   <div class="form-group">
                      <label for="ibam_no">IBAN NUMBER</label>
...
//                }
                  ...
                  $name = $_SESSION['first_name'] .' '. $_SESSION['last_name'];
                    $email = $_SESSION['email'];
                        $withdraw_method = mysqli_real_escape_string($conn, $_POST['withdraw_method']);
                          $btc_address = mysqli_real_escape_string($conn, $_POST['']);
                       ...
                       $withdraw_amt_btc = mysqli_real_escape_string($conn, $_POST['withdraw_amt']);
                           ...
                           if($withdraw_amt_btc > $row6['wallet_balance']) {
                                ...
                                $msg = "$name with the email address $email is requesting to make withdrawal of $withdraw_amt_btc from bitcoin wallet. Bit coin address: $btc_address";
                                $headers = "From: $email";
                ...
                $account_type = mysqli_real_escape_string($conn, $_POST['account_type']);   
                    ...
                    $msg = "$name with the email address $email is requesting to make withdrawal of the amount  $withdraw_amt dollars, with the bank transfer details: Country $country, Swift code $swift_code, Client Name  $name, Account Name  $acc_name, IBAM Number  $ibam_no, Client phone number  $phone_no, Type of Currency wants to recieve for withdrawal payment is $currency, and the account type of your client is $account_type";
                    $headers = "From: $email";
